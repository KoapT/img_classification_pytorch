...
data_group.add_argument('-j', '--workers', dest='num_workers', default=8,
                        type=int, metavar='N',
...
arch_group.add_argument('--pretrained', action='store_true',
                        help='load the pretrained parameters')
...
optim_group.add_argument('--trainer', default='train_test', type=str,
...
optim_group.add_argument('--decay_at_epochs', nargs='*',
                         help='learning rate will decay at these epochs')
...
optim_group.add_argument('--fixed-module-flags', nargs='*',
                         help='the modules with flags to be fixed (not to be trained)')
optim_group.add_argument('--optimizer', default='sgd',
                         choices=['sgd', 'rmsprop', 'adam'], metavar='N',
                         help='optimizer (default=sgd)')
optim_group.add_argument('--load-optimizer', action='store_true',
                         help='load the old optimizer')
